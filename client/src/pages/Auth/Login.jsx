  ...
  return (
    <div className="max-w-full grow-0 shrink-0 basis-full">
      ...
      <p className="text-[#AAAAAA] text-[16px] mb-7 text-left">
        Need an account?
        <Link to="/auth/register" className="text-[#18AEFA]">
          {" "}
          Sign Up{" "}
        </Link>
      </p>
      ...
      <form action="">
        ...
        <div className="relative mb-5">
          ...
          <span className="absolute right-[17px] top-1/2 -translate-y-1/2">
            {passwordVisible === false ? (
              <FaRegEye onClick={() => setPasswordVisible(!passwordVisible)} />
            ) : (
              <FaRegEyeSlash
        ...
        <div className="flex mb-5">
          <div>
            <label className="text-[#878787] font-normal relative pl-7 cursor-pointer">
              Remember me
              <input
                type="checkbox"
                name="radio"
              ...
              <span
                ...
                className={`size-5 absolute left-0 top-0 border border-solid rounded 
                                ${
                                  rememberMe === false
                                    ? "border-[#C1CCDB] bg-white"
                                    : "border-[#3d5ee1] bg-[#3d5ee1]"
                                }`}
              >
                <FaCheck className="block absolute left-[5px] top-[4px] text-white text-[9px]" />
              </span>
            </label>
          </div>
          <Link
            to="/auth/forgot-password"
            className="text-[#18AEFA] text-[15px] ml-auto"
          >
            Forgot Password?
          </Link>
        </div>
      ...
      <div className="text-[#a0a0a0] my-5 py-3 relative">
        ...
        <span className="bg-white block absolute top-0 left-1/2 ml-[-20px] text-center uppercase w-[42px]">
          or
        </span>
      </div>
