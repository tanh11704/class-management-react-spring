...
const ForgotPassword = () => {
    return (
        <div className="max-w-full grow-0 shrink-0 basis-full">
            <h1 className="text-[25px] font-bold mb-[5px] text-left">Reset Password</h1>
            ...
            <form action="">
                ...
                <div className="relative mb-5">
                    <button
                        className="w-full bg-[#18aefa] border-solid py-1.5 text-white rounded-[6px] hover:bg-[#3d5ee1] transition-all duration-400">
